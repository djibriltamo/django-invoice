    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total', models.DecimalField(decimal_places=5, max_digits=50000)),
                ('last_updated_date', models.DateTimeField(blank=True, null=True)),
                ('paid', models.BooleanField(default=False)),
                ('invoice_type', models.CharField(choices=[('R', 'RECU'), ('P', 'FACTURE PREFORMA'), ('F', 'FACTURE')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_price', models.DecimalField(decimal_places=5, max_digits=10000)),
                ('total', models.DecimalField(decimal_places=5, max_digits=10000)),
